...
var proto = protobufjs.loadProtoFile(path.join(__dirname, 'Mumble.proto'));
var mumble = proto.build('MumbleProto');
var messages = {};
var context = {schema: mumble};

module.exports.EncodePacket = function(type, payload) {
